...
| **+ menu** ✅ | Attach first, then Learn and Research each with a one-line description — Gemini's and ChatGPT's tool menu, for the person who reads menus rather than chips. | Compare, Temporary. |
