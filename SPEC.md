...
| **Navy ground, blue and cyan** ✅ | Almaz's navy ground — page `#080B12`, panels and sidebar `#0E1420`, cards `#121A27`, raised `#182231`, borders `#253244`, text `#F5F7FA` / `#9AA6B5` (with derived steps `#8893a2`, `#828d9c` and a strong border `#5f7089` that holds 3:1) — carrying the accents the app had before: soft blue `#a3bae7` for structure (links, focus, the active row's icon) and cyan for the signal and the one button a screen asks you to press (`#84d1d1` with `#031515` ink). Electric blue, violet and neon were tried on this ground and set aside at Almaz's word. Light keeps its earlier blue and teal accents on the re-stepped text ladder. Gate: `contrast`, `theme-parity`, `type-scale`, `depth`, `audit`, `test-tokens`. | — |
