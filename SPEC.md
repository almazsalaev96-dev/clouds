...
| **The ladder in the menu** ✅ | The picker lists the four tiers in the order Auto climbs them, each with its rung marked (one to four bars) and its cost per answer, then the specialists; the chosen model's face is on the bar. Gate: `e2e-presets`, `e2e-auto`. | — |
