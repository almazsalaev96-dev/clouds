...
for (const theme of ["light", "dark"]) {
  ...
  await page.evaluate((t) => {
    localStorage.setItem("armi.settings", JSON.stringify({ state: { theme: t, density: "comfortable", modelId: "claude-sonnet-4-5", section: "chat", sidebarOpen: true, sendOnEnter: true, showLineNumbers: false, wrapCode: false, keys: { anthropic: "sk-ant-demo" }, params: {}, favorites: [], recentModels: [], systemPrompt: "" }, version: 1 }));
  }, theme);
